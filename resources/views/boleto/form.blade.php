<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('viaje',$viaje, ['readonly','class' => 'form-control' . ($errors->has('id_viaje') ? ' is-invalid' : ''), 'placeholder' => 'Id Viaje']) }}
...
<br>
    ...
    <div class="box-footer mt20">
        ...
        <a href="{{ route('boletos.index') }}" class="btn btn-primary">{{ __('Regresar') }}</a>
    </div>
</div>